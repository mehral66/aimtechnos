...
! function (e, n) {
  ...
  e.fn.fullpage = function (l) {
    ...
    function ze() {
      var e = n.location.hash.replace("#", "").split("index.html"),
    ...
    function Jn() {
      var n = e(b),
        ...
        i = Kn(t),
        r = String(o);
      t.length && (r = r + "-" + i), r = r.replace("index.html", "-").replace("#", "");
          ...
          if (!h.isOpen) {
            ...
            a.each(d, function (b, c) {
              ...
              if (-1 === a.inArray(e, j)) {
                ...
                /youtube/i.test(e) ? (d = e.substring(e.lastIndexOf("v=") + 2), /autoplay=/i.test(d) || (d += "&autoplay=1"), d = d.replace(/\?|&/, "?"), g = "//www.youtube.com/embed/" + d, k = "isYoutube") : /vimeo\.com/i.test(e) ? (d = e.substring(e.lastIndexOf("index.html") + 1), /autoplay=/i.test(d) || (d += "&autoplay=1"), d = d.replace(/\?|&/, "?"), g = "//player.vimeo.com/video/" + d, k = "isVimeo") : /www\.ted\.com/i.test(e) ? (g = "http://embed.ted.com/talks/" + e.substring(e.lastIndexOf("index.html") + 1) + ".html", k = "isTed") : /soundcloud\.com/i.test(e) ? (g = e, k = "isSoundCloud") : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(e) ? (g = e.split(-1 !== e.indexOf("|") ? "|" : "%7C"), k = "isSelfHostedVideo") : /\.mp3$/i.test(e) && (g = e, k = "isSelfHostedAudio"), h.dataArray.push({
                  src: g,
